...
static int bcm_handle_key_state(struct bcm_keypad *bcm_kb);
    ...
    for (index = 0; index < MATRIX_SIZE; index++) 
    {
        ...
        else 
        {
			...
			if((vk==KEY_HOME)||(vk==KEY_MENU))
			{
                    		...
                    		{
								KEYDBG("[%02d:%02d:%02d.%03lu] check_4key_press1 ignore =%d\n",  tm.tm_hour, tm.tm_min, tm.tm_sec, ts.tv_nsec, vk);
								return 0;
							}
							else
							{
								KEYDBG("check_4key_press1 check_4key_vk1 =%d, check_4key_press1=%d, vk=%d\n",  check_4key_vk1, check_4key_press1, vk);
								check_4key_vk1=vk;
								check_4key_press1=1;
							}
						}
                    	else if((vk==KEY_BACK)||(vk==KEY_SEARCH))
                    	{
                    		...
                    		{
								KEYDBG("[%02d:%02d:%02d.%03lu] check_4key_press2 ignore =%d\n",  tm.tm_hour, tm.tm_min, tm.tm_sec, ts.tv_nsec, vk);
								return 0;
							}
							else
							{
								KEYDBG("check_4key_press1 check_4key_vk2 =%d, check_4key_press2=%d, vk=%d\n",  check_4key_vk2, check_4key_press2, vk);
								check_4key_vk2=vk;
								check_4key_press2=1;
							}
			...
			if(((check_4key_vk1==KEY_MENU)&&(check_4key_press1==1)&&(vk==KEY_HOME))||((check_4key_vk1==KEY_HOME)&&(check_4key_press1==1)&&(vk==KEY_MENU)))
			      {
					...
					return 0;
							...
							{
				        KEYDBG("check_4key_rlease check_4key_vk1 =%d, check_4key_press1=%d, vk=%d\n",  check_4key_vk1, check_4key_press1, vk);
					check_4key_vk1=vk;
								check_4key_press1=0;
							}
						}
						else if((vk==KEY_BACK)||(vk==KEY_SEARCH))
						{
							...
							{
								KEYDBG("check_4key_rlease check_4key_vk2 =%d, check_4key_press1=%d, vk=%d\n",  check_4key_vk2, check_4key_press2, vk);
								check_4key_vk2=vk;
								check_4key_press2=0;
							}
